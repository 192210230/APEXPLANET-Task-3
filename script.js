    ...
    cardContainer.innerHTML = `
      <div class="card">
        ...
        <div class="details-block">
          <p><strong>ð¤ Name:</strong> ${found.name}</p>
          <p><strong>ðï¸ Role:</strong> ${found.role}</p>
          <p><strong>ð Bio:</strong> ${found.bio}</p>
          <p class="inspiration"><strong>ð¬ Quote:</strong> "${found.quote}"</p>
        </div>
      </div>
    `;
  } else {
